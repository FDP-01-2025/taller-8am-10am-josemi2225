...
void eliminarEstudiante() {
    ...
    if (archivo.is_open() && temp.is_open()) {
        while (archivo >> e.nombre >> e.carnet >> ) {
            if (e.carnet == eleminando) {
                Estudiante nuevo;
                cout << "Nombre del estudiante a eliminar: \n";
                cin >> eliminar.Estudiante;
                cout << "Ingrese el carnet del estudiante a eliminar: \n";
                cin >> eliminar.carnet;
                

                temp << eliminar.Estudiante << " " << eliminar.carnet << " " << endl;
                modificado = true;
            } else {
                temp << e.nombre << " " << e.carnet << " " << endl;
            }
        }
        archivo.close();
        temp.close();
